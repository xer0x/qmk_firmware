...
// Mod-tap CTRL->ESC via https://docs.qmk.fm/#/feature_advanced_keycodes
#define CTRLESC LCTL_T(KC_ESC)

// Default layer
// top: ESC -> GESC w/ ` on Shift/GUI
// 2: KC_LCTL -> MT(KC_ESC, KC_LCTL)
// 3: KC_LSFT -> KC_LSPO, KC_RSFT -> KC_LSPC
// bottom row: swapped KC_LALT with KC_LGUI.   KC_LCTL and KC_RALT and KC_RCTL do not have switches
[0] = LAYOUT_all(
	KC_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,
	KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
	CTRLESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
	KC_LSPO, KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, MO(1),
